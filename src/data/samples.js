const samples = [
  {
    ...
    description:
      'Potential interview questions for a modern front-end engineering position with a focus on: Javascript/ES6, ReactJS, HTML5, and CSS3.',
    cards: [
      {
        title: 'What is a closure in Javascript?',
        answer:
          'A closure is when a function is bound to its calling function and has access to the variables in the parent scope.\n\nCommon example:\n\n**Write a for loop that creates a list of functions that spit out the current number of the iteration**\n\n```\nfunction iterate(k) {\n    var funcs = [];\n    for(var i = 0; i < k; i++) {\n      (function(num) {\n        funcs.push(function() {\n          return num;\n        });\n      })(i);\n    }\n    return funcs;\n  }\n\n  const test = f(4);\n  console.log(test[0]()); // 0\n  console.log(test[1]()); // 1\n  console.log(test[2]()); // 2\n  console.log(test[3]()); // 3\n```',
        index: 1,
      },
      {
        title: 'What is a callback?',
        answer:
          "A callback function is a reference to a function that is called after a certain action is complete. Used heavily for handling AJAX requests in the past.\n\n\n**Example**\n\n```\nvar a = function() {\n  console.log('a called');\n};\nvar b = function(callback) {\n  setTimeout(200, callback);\n};\n\nb(a);\n'a is called' will appear after 200 ms\n```",
        index: 2,
      },
      {
        title: 'What does IIFE stand for and what are its uses in practice?',
        answer:
          'An IIFE stands for an **I**mmediately **I**nvokable **F**unction **E**xpression, which looks like the following:\n\n```\n(someFunction())();\n```\n\nIIFEs are useful for preventing variables from leaking into the global scope. It is also useful for nullifying closures by introducing an artificially empty scope.',
        index: 3,
      },
      {
        title:
      ...
      {
        title:
          'How can you tell what `this` is referencing at different points inside a function/class?',
        answer: '',
        index: 8,
      },
      {
      ...
      {
        title:
          'What is the difference between `x is undefined` and `x is not defined` error messages?',
        answer: '',
        index: 11,
      },
      {
        ...
        answer:
          'A doctype tells the browser against which specification of HTML to render the page\n',
        index: 12,
      },
      {
        title:
      ...
      },
      {
        ...
        answer:
          '`data-` attributes allow you to add non-standard attributes to a DOM element that can be accessed through JS.',
        index: 15,
      },
      {
        title:
      ...
      },
      {
        ...
        answer:
          'Multiple CSS classes can be combined together and can follow a inheritance pattern. \n\nIDs in CSS are unique and its rules take precedence over classes.',
        index: 19,
      },
      {
        title:
        ...
        answer:
          'Normalizing CSS **preserves useful defaults**, whereas resetting CSS unstyles virtually everything.',
        index: 20,
      },
      {
        title:
      ...
      },
      {
        ...
        answer:
          'Psuedo-elements in CSS are for algorithmically selecting elements.\n\n```\n:first-child\n:nth-element[x]\n```',
        index: 23,
      },
      {
        title:
      ...
      },
      {
        ...
        answer:
          '**Native objects** are objects that are specified in the ECMAScript standard. **Host objects** are objects provided by the environment, either the browser or V8 (Node)\n\n# Examples\nNative objects: Object (constructor), Date, Math, parseInt, eval, string methods like indexOf and replace, array methods, ...\n\nHost objects (assuming browser environment): window, document, location, history, XMLHttpRequest, setTimeout, getElementsByTagName, querySelectorAll, ...',
        index: 33,
      },
      {
        title:
          "What's the difference between `Function.prototype.call` and `Function.prototype.apply`?",
        answer:
          'They both require a context for the first argument (usually `null` or `this`). The two functions are nearly identical, however, `Function.apply` accepts an array of values for the second argument. `Function.call` accepts n arguments after the context.',
        index: 34,
      },
      {
      ...
      },
      {
        ...
        answer:
          "In Javascript, functions are \"hoisted\" to the top of the scope. For example, a function that is defined near the bottom of the code can be called from the top.\n\n```\na()\n\nfunction a() {\n  console.log('this works');\n}\n\nconsole.log(b); // Error: b not defined\n\nvar b = 'but this does not';\n```",
        index: 40,
      },
      {
        title: 'What is the difference between `==` and `===`?',
        answer:
          '**Double equals (==)** is a value equality operator that infers the type of the operands and returns true if and only if their inferred values match\n\n**Triple equals (===)** is a type and value equality operator that returns true if and only if both match',
        index: 41,
      },
      {
        title:
      ...
      {
        title:
          'In the Javascript event loop, what is the difference between call stack and task queue?',
        answer: '',
        index: 44,
      },
      {
  ...
  },
  {
    ...
    description:
      "Questions and answers that will help prepare for the California DMV drivers' license exam.",
    cards: [
      {
        title:
      ...
      {
        title:
          'In California, it is illegal for any person under the age of 21 to operate a motor vehicle if their Blood Alcohol Concentration is at or higher than what?',
        answer:
          'Under California law, it is illegal for any person under the age of 21 to operate a motor vehicle with a BAC of **0.01% or higher**.',
        index: 2,
      },
      {
        title:
        ...
        answer:
          'When two vehicles meet on a steep road where neither vehicle can pass, it is the vehicle **pointing downhill** that should yield the right of way by backing up, because the vehicle facing downhill has the greater amount of control when backing up.',
        index: 3,
      },
      {
        title:
      ...
      },
      {
        ...
        answer:
          "The DMV's standard vision requirement is 20/40 for drivers with or without corrective vision. If you do not meet this requirement, you must set up an appointment with a vision specialist.\n\n_[Page, 16. Vision, Miscellaneous Licensing Information, California Drivers Handbook]_",
        index: 7,
      },
      {
      ...
      {
        title:
          'To avoid last minute moves, you should be looking down the road to where your vehicle will be in about _______ seconds.',
        answer: '10 to 15 seconds',
        index: 9,
      },
      {
        title:
          'To turn left from a multilane one-way street onto a one-way street, you should turn from:',
      ...
      {
        title:
          'When two vehicles from different directions arrive at the same time at a four-way stop, which one should be given the right-of-way?',
        answer:
      ...
      {
        title:
          'Parking close to the driveway entrance to a fire station is allowed, if you keep the following distance from the driveway',
        answer:
  ...
  },
  {
    ...
    description:
      'Material for studying basic concepts of the React/Redux framework.\n\nLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
    cards: [
      {
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title:
          '![](http://www.seriouseats.com/recipes/assets_c/2016/07/20160711-gyudon-beef-rice-bowl-japanese-recipe-16-thumb-1500xauto-433093.jpg)Gyudon',
        answer:
